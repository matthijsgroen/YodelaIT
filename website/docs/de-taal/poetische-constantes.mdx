...
- <LineExample>Andre zegt Hallo Den Haag!</LineExample> initialiseert de variabele
  `Andre` met de tekst `"Hallo Den Haag!"`.
- <LineExample>Den Haag zegt Hallo terug</LineExample> initialiseert de variabele
  `Den Haag` met de tekst `"Hallo terug"`.
- <LineExample>Jij zegt dat ik te min ben</LineExample> initialiseert de variabele
...
- <LineExample>Henk is fantastisch emotionele kunstenaar</LineExample> initialiseert
  `Henk` met de waarde `100`
- <LineExample>Andre was een man van het volk</LineExample> initialiseert `Andre`
  met de waarde `33334`
- <LineExample>{`Mijn dromen waren kil. Achterdocht deed huiveringen tonen`}</LineExample> initialiseert
  `Mijn dromen` met de waarde `3.1415`
- <LineExample>Sjaak was zonder</LineExample> initialiseert `Sjaak` met de waarde
